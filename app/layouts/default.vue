...
<template>
  <div class="min-h-screen flex flex-col bg-background text-foreground">
        ...
        <div class="flex items-center gap-1">
          <nav aria-label="Main navigation">
            <ul class="m-0 flex list-none items-center gap-1 p-0">
              <li>
                <NuxtLink to="/" active-class="text-accent" class="inline-flex items-center px-2 py-2 min-h-11">Home
                </NuxtLink>
              </li>
              <li>
                <NuxtLink to="/guide" active-class="text-accent" class="inline-flex items-center px-2 py-2 min-h-11">
                  Guide</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/about" active-class="text-accent" class="inline-flex items-center px-2 py-2 min-h-11">
                  About</NuxtLink>
              </li>
            </ul>
          </nav>
          ...
          <button type="button"
            ...
            :aria-label="isDark ? 'Switch to light mode' : 'Switch to dark mode'" @click="toggleColorMode">
    ...
    <main id="main-content" tabindex="-1" class="mx-auto w-full flex-1 px-4 py-8 sm:px-6 focus-visible:outline-none">
      <slot />
    </main>
    ...
    <footer class="border-t">
      <div class="flex flex-col justify-center items-center gap-1 px-4 py-4 sm:px-6">
        ...
        <NuxtLink to="https://github.com/nconklindev/wfm-relay"
